_define_("jsutils.file", function(file) {
    ...
    file.loadView = function(htmlSrc, dataSrc, dummyData) {
        ...
        $viewDffPromise.___loadTemplate___dummyData___ = dummyData || true;
        return $viewDffPromise;
    };
    ...
    var loadTemp = function(htmlSrc, dataSrc, dummyData) {
        ...
        (function(_dummyData) {
            if (htmlSrc.___loadTemplate___dummyData___) {
                if (htmlSrc.___loadTemplate___dummyData___ === true) {
                    dummyData = _dummyData;
                } else {
                    dummyData = htmlSrc.___loadTemplate___dummyData___;
                }
                return htmlSrc;
            }
            return file.loadTemplate(htmlSrc, dataSrc, dummyData);
